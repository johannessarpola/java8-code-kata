...
public class Exercise1Test extends ClassicOnlineStore {
    ...
    public void whoHaveNoEInYourName() {
        ...
        nameCollection = nameCollection.stream().filter(predicate).collect(Collectors.toList());
    ...
    public void sortByName() {
         ...
         */
        Comparator<String> comparator = (s1, s2) -> (new Integer(s1.length()).compareTo(s2.length()));
