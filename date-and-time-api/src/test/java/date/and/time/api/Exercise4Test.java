...
public class Exercise4Test {
    ...
    public void zonedDateTimeOf() {
         ...
         */
        ZonedDateTime zonedDateTime = ZonedDateTime.of(LocalDate.of(2015, Month.JULY, 10), LocalTime.of(2,14,25), ZoneId.of(ZoneId.SHORT_IDS.get("JST")));
    ...
    public void zonedDateTimeParse() {
         ...
         */
        ZonedDateTime zonedDateTime = ZonedDateTime.of(LocalDate.of(2015, Month.JUNE, 18), LocalTime.of(23,07,25), ZoneId.of(ZoneId.SHORT_IDS.get("JST")));
    ...
    public void zonedDateTimeFormat() {
         ...
         */
        String strZdt = zdt.format(DateTimeFormatter.ofPattern("yyyy_MM_dd_H_mm_s_z"));
